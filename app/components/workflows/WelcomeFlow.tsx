      ...
      {!addTapped ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <p className="text-white/90 text-sm leading-relaxed">
                Would you like ember to call you to talk about this memory, or would you prefer to chat here?
              </p>
            </div>
          </div>
          ...
          {addStep === null ? (
            ...
            <>
              <div className="flex flex-col items-end gap-1">
                <span className="text-xs font-medium pr-1 text-white/30">you</span>
                <div className="inline-block max-w-[85%] rounded-2xl rounded-tr-sm px-4 py-2.5" style={{ background: "#2e3a4e" }}>
                  <p className="text-white/90 text-sm leading-relaxed">{phoneFromChat ? "Let\u2019s move to a phone call." : "I\u2019ll take the phone call."}</p>
                </div>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-xs font-medium pl-1 text-white">ember</span>
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                <Link href="/home?ember=welcome&step=adding&sub=phone-from-chat" className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "transparent", border: "1.5px solid var(--border-btn)" }}>
