...
export async function GET(
  ...
  try {
    ...
    // After setting a password, /inbound/[token] detects the session and
    // routes them into ContributorPWFlow instead of ContributorNPWFlow.
    const next = encodeURIComponent(`/inbound/${token}`);
