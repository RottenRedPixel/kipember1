...
export default function GuestContributorAddFlow({ token }: { token: string }) {
  ...
  const base = `/guest/${token}?ember=contrib-add`;
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          <p className="text-white/90 text-sm leading-relaxed">
            You&apos;ve been invited to share your memory of this moment. Would you like ember to
            call you or continue chatting here?
          </p>
        </div>
      </div>
